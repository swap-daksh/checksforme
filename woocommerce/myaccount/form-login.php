...
<?php endif; ?>
		...
		<form class="woocommerce-form woocommerce-form-login login" method="post">
			...
			<span class="ordering_mesg">
                  <strong><?php the_field('tagline_text'); ?></strong>
                   <a class="btn check acc-order" href="<?php the_field('button_link_or');?>"><?php the_field('order_now_button_acc'); ?></a>
        </span>
